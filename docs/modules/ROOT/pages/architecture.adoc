...
The scaler layer sits between deal planning and Hyperliquid submission. It applies global
and per-bot multipliers, records scaled order audits, and streams configuration changes via
SSE. See xref:architecture/order-scaler.adoc[Order scaler architecture] for the data model
and runtime flow.
